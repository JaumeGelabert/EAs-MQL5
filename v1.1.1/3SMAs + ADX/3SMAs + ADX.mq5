      ...
      if(Digits() == 5)   //--- 5 DIGITOS
        {
         ...
         if((((SMA_Array_A[0]>SMA_Array_B[0]) && (SMA_Array_C[0]>SMA_Array_A[0])) && ((SMA_Array_A[1]<SMA_Array_B[1]) && (SMA_Array_C[1]>SMA_Array_B[1]))) && (Valor_ADX > Valor_ADX_Necesario))   //--- BUY
           {
